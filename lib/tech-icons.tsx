...
import { FaAws, FaSlack, FaLinkedin } from "react-icons/fa";
import {
  MousePointer2,
  Sparkles,
  ChartColumn,
...
type IconComp = ComponentType<SVGProps<SVGSVGElement> & { size?: number | string; color?: string; title?: string }>;
...
export const TECH_ICONS: Record<string, IconEntry> = {
  ...
  "OpenAI Codex": { Icon: Bot, color: "#412991" },
  Cursor: { Icon: MousePointer2, color: "#A78BFA" },
  "Prompt engineering": { Icon: Sparkles, color: "#F472B6" },
  "LLM evaluation": { Icon: TestTube, color: "#F472B6" },
  "Machine learning": { Icon: Brain, color: "#F472B6" },
  ML: { Icon: Brain, color: "#F472B6" },
  "AI-assisted development": { Icon: Sparkles, color: "#F472B6" },
  "Data analytics": { Icon: ChartColumn, color: "#F472B6" },
  "Data visualization": { Icon: ChartLine, color: "#67E8F9" },
  "Data insights": { Icon: ChartLine, color: "#F472B6" },
  ...
  NetSuite: { Icon: Database, color: "#C74634" },

  // Practices
  "Agile / Scrum": { Icon: Repeat, color: PRACTICES_COLOR },
  Kanban: { Icon: SquareKanban, color: PRACTICES_COLOR },
  SDLC: { Icon: Columns3, color: PRACTICES_COLOR },
  TDD: { Icon: TestTube, color: PRACTICES_COLOR },
  "CI/CD": { Icon: GitBranch, color: PRACTICES_COLOR },
  "Unit & automated testing": { Icon: TestTube, color: PRACTICES_COLOR },
  "Project management": { Icon: SquareKanban, color: PRACTICES_COLOR },
  "E-commerce operations": { Icon: ShoppingCart, color: PRACTICES_COLOR },
  "EDI / XML / XSLT mapping": { Icon: FileCode, color: PRACTICES_COLOR },
  "BI reporting": { Icon: ChartLine, color: PRACTICES_COLOR },
  VBA: { Icon: FileCode, color: PRACTICES_COLOR },

  // Domain
  "E-commerce": { Icon: ShoppingBag, color: "#7AB55C" },
  SEO: { Icon: Search, color: "#A78BFA" },
  "Team leadership": { Icon: Users, color: "#A78BFA" },
  EDI: { Icon: FileCode, color: "#A78BFA" },
  "XML/XSLT": { Icon: FileCode, color: "#A78BFA" },
  "B2B integrations": { Icon: Network, color: "#A78BFA" },
  "BI Publisher": { Icon: ChartLine, color: "#A78BFA" },
